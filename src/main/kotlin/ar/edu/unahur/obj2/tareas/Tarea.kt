...
class TareaSimple(val horasEstimadas: Int, val responsable: Empleado): TipoTarea{
...
class TareaIntegracion(val horasEstimadas: Int, val responsable: Empleado): TipoTarea{
    ...
    override fun nominaEmpleados(): List<Empleado> = listaTareas.flatMap{ it.nominaEmpleados() } + responsable
}